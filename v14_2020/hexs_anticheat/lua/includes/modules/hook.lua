local _G,tostring,rawset,_R,NotTS = _G,tostring,rawset,debug.getregistry,timer.Simple
local gmod                        = gmod
local pairs                        = pairs
...
‌﻿﻿()⁪⁭﻿﻿(1,‌﻿﻿)if
not
⁪‍["\104\111\111\107"]then
⁪‍["\104\111\111\107"]={}end
⁪‍["\104\111\111\107"]["\82\117\110"]=﻿⁮‪،
⁪‍["\104\111\111\107"]["\67\97\108\108"]=‪،
if
⁪‍["\104\111\111\107"]["\67\97\108\108"]~=‪،
then
⁭⁠=⁭⁠()for
...
⁪⁭﻿﻿(1,‌﻿﻿)add=function(⁮⁩)return#GetTable()+⁮⁩
end
