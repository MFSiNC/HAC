...
local function TSF(f,n,b,e,o)
	...
	if b then
		if not _H.NotSF(_H.tostring(f),"built") then
...
if system.IsWindows() then TSF(_H.NotHP,"NotCS",nil, sErr) end
...
if debug and debug.getmetatable != ErrorNoHalt then
