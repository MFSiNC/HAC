HAC.Bind2 = {
	Spam = {"Did you know I am a fruit!", "I really love fruit!", "You caught me with fruit down my trousers!", "Did you know that the bird is indeed the WATERMELON?", "Do you have any melons?", "TIME FOR oranges!",},
	Model = {"models/props_junk/watermelon01.mdl", "models/props/cs_italy/bananna_bunch.mdl", "models/props/cs_italy/orange.mdl",},
	Sound = {"vo/k_lab/al_allrightdoc.wav", "vo/k_lab/al_carefulthere.wav", "vo/k_lab/al_seeifitworks.wav", "vo/k_lab/al_theswitch.wav", "vo/k_lab/al_uhoh01.wav", "vo/k_lab/ba_cantlook.wav", "vo/k_lab/ba_careful01.wav", "vo/k_lab/ba_careful02.wav", "vo/k_lab/ba_itsworking01.wav", "vo/k_lab/ba_thingaway03.wav", "vo/k_lab/eli_didntcomethru.wav", "vo/k_lab/kl_almostforgot.wav", "vo/k_lab/kl_ohdear.wav",},
}
