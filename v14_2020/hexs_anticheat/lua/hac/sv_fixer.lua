...
HAC.Fixer.GetInfo = {
	...
	["material_override"] = {
		...
		OnStart = function(self)
			HAC.Fixer.V_ListOf(self, "OverrideMaterials", true)
		end,
	},
	--Trail
	["trails_material"] = {
		Reset = "trails/lol",
		OnStart = function(self)
			HAC.Fixer.V_ListOf(self, "trail_materials")
		end,
	},
	--Button
	["button_model"] = {
		...
		OnStart = function(self)
			HAC.Fixer.K_ListOf(self, "ButtonModels", true)
		end,
	},
	--Dynamite
	["dynamite_model"] = {
		...
		OnStart = function(self)
			HAC.Fixer.K_ListOf(self, "DynamiteModels", true)
		end,
	},
	--Emitter
	["emitter_effect"] = {
		Reset = "sparks",
		OnStart = function(self)
			HAC.Fixer.K_ListOf(self, "EffectType")
		end,
	},
	--Hoverball
	["hoverball_model"] = {
		...
		OnStart = function(self)
			HAC.Fixer.K_ListOf(self, "HoverballModels", true)
		end,
	},
	--Muscle
	["muscle_material"] = {
	...
	["paint_decal"] = {
		Reset = "blood",
		OnStart = function(self)
			HAC.Fixer.V_ListOf(self, "PaintMaterials", true)
		end,
	},
	--Thruster
	["thruster_model"] = {
		...
		OnStart = function(self)
			HAC.Fixer.K_ListOf(self, "ThrusterModels", true)
		end,
	},
	["thruster_effect"] = {
		Reset = "fire",
...
--GetInfo
--Spammed a lot, account for this!
HAC.Detour.Meta("Player", "GetInfo", function(self, CVar)
...
--GetInfoNum
--Spammed a lot, account for this!
HAC.Detour.Meta("Player", "GetInfoNum", function(self, CVar, Def)
