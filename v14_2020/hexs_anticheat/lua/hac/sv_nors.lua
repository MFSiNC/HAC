HAC.NoRS = {
	Good = {
		["addons/hexs_server_plugins/lua/hsp_plugins.lua"] = 1,
		["addons/hexs_server_plugins/lua/hsp/general/sv_chatlua.lua"] = 1,
		["addons/hexs_anticheat/lua/hac/sv_skidcheck.lua"] = 1,
		["addons/hexs_anticheat/lua/hac/sv_twoscore.lua"] = 1,
		["addons/hexs_anticheat/lua/hac/sv_fixenum.lua"] = 1,
		["addons/hexs_anticheat/lua/hac/sv_norp.lua"] = 1,
		["lua/tft.lua"] = 1,
	}
}
...
local function RunStringEx(str, ras)
	...
	if not HAC.NoRS and HAC.NoRS.Good[path] then
		GetBooty(str)
