HAC.Chk = {
	...
	HACd = {"===Bucket===", "===BadFile===", "===Dirty hacks===", "===DStream===",},
}
...
function HAC.Chk.Check(self, This, CRC, typ, Cont)
	...
	if not Data and not Root and (This:Check("lua/entities/") or This:Check("lua/weapons/")) then return end
	...
	if Found then
		...
		--Delete
		HAC.Chk.Delete(self, Low)
		--No need to log if banned already
