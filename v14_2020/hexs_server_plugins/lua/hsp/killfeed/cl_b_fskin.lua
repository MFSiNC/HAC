...
SKIN.UH_DarkGrey  = Color(20,20,20,100) --190

SKIN.UH_LightGrey = Color(90,90,90,100) --200
...
function SKIN:PaintScorePanelHeader(panel)	end
...
function SKIN:SchemeScorePanelLabel(panel)
	...
	panel:SetTextColor(panel.pPlayer:TeamColor())
...
function SKIN:PaintGameNotice(panel)
	...
	if (panel.m_bHighlight) then
		...
		draw.RoundedBox(4,0,0,panel:GetWide(),panel:GetTall(),self.UH_LightGrey)
	...
	draw.RoundedBox(4,0,0,panel:GetWide(),panel:GetTall(),self.UH_DarkGrey)
...
function SKIN:SchemeGameNoticeLabel(panel)
	...
	panel.m_FontName = "FRETTA_NOTIFY"
